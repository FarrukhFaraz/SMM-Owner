  ...
  Widget build(BuildContext context) {
    return BlocBuilder<EnvCubit, ENVModel>(
      builder: (context, envModel) {
        ...
        List<Color> backgroundColors = loginConfig.backgroundColor.length > 1 ? loginConfig.backgroundColor : [Color(0xff4c8479), Color(0xff2b5f56)];
        return Scaffold(
          body: Container(
                    ...
                    if (loginConfig.backgroundImage.isNotEmpty) ...{
                      Container(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(120),
                            gradient: RadialGradient(colors: backgroundColors),
                          ...
                          child: Padding(
                            ...
                            child: TextButton(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(color: Colors.white70, decoration: TextDecoration.underline , height: 1),
                              ),
                            ),
                          ),
                        ),
