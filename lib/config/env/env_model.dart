...
class ENVModel {
  ...
  ENVModel({required this.loginConfig, required this.signupConfig, required this.forgotpasswordConfig});
  ...
  factory ENVModel.fromEnvironment(Map<String, dynamic> env) {
    return ENVModel(
      ...
      forgotpasswordConfig: ForgotPasswordConfig.fromMap(env['forgetPasswordConfig'] ?? {}),
    );
  }
}
