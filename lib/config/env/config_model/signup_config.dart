...
class SignupConfig {
  ...
  factory SignupConfig.fromMap(Map<String, dynamic> map) {
    return SignupConfig(
      ...
      cancelIconColor: map["cancelIconColor"] ?? "#FFFFFF",
      ...
      textFieldHintColor: map["textFieldHintColor"] ?? Colors.grey,
      textFieldIconColor: map["textFieldIconColor"] ?? Colors.grey,
      focusBorderColor: map['focusBorderColor'] ?? Colors.black,
      inputTextColor: map['inputTextColor'] ?? Colors.black,
      buttonBackgroundColor: map["buttonBackgroundColor"] ?? Colors.teal,
